...
String id = (report != null && report.getReport_id() != null) ? report.getReport_id(): "";
String app_date = (report != null && report.getApplication_date() != null) ? report.getApplication_date() : "";

String student_id = (report != null && report.getStudent_id() != null) ? report.getStudent_id(): "";
...
<head>
  <meta charset="UTF-8">
  <title>No.Report_報告書詳細</title>
  <link rel="stylesheet" href="css/page11.css">
</head>
<body>
  <div class="report-check-container">
    <h1 style="text-align: center;">報告書詳細</h1> 

    <form action="ReportApplicationServlet" method="post" autocomplete="off">
        ...
        <div class="row-group">
            ...
            <div class="field-item">
                <label>名前</label>
                <div class="card-value-box"><%=report_name%></div>
            </div>
        </div>
<hr>
        <div class="row-group">
        ...
        <label>活動レポート</label>
        <div class="report-text-area"><%=activity_report%></div>
