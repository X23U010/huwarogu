...
String public_absence_name = (String) session.getAttribute("public_absence_name");

String id = (pa != null && pa.getPublic_absence_id() != null) ? pa.getPublic_absence_id() : "";
String app_date = (pa != null && pa.getApplication_date() != null) ? pa.getApplication_date() : "";

String student_id = (pa != null && pa.getStudent_id() != null) ? pa.getStudent_id(): "";
...
<body>
  <div class="report-check-container">
    ...
    <form action="PubAbApplicationServlet" method="post" autocomplete="off">
        <%-- DB登録用の隠しデータ --%>
		...
		<div class="row-group">
            <div class="field-item">
                <label>報告書ID</label>
                <div class="card-value-box"><%=id%></div>
            </div>
            <div class="field-item">
                <label>提出日</label>
                <div class="card-value-box"><%=app_date%></div>
            </div>
        </div>
        ...
        <div class="row-group">
            <div class="field-item">
                <label>学籍番号</label>
                <div class="card-value-box"><%=student_id%></div>
            </div>
            <div class="field-item">
                <label>名前</label>
                <div class="card-value-box"><%=public_absence_name%></div>
            </div>
        </div>
        ...
        <div class="buttons">
            <button type="submit" class="back-btn" name="action" value="back_022">戻る</button>
        </div>
    </form>
  </div>
</body>
